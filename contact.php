...
function myMap() {
var mapProp= {
  center:new google.maps.LatLng(36.714670,-4.424500),
  zoom:5,
};
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCibJhykSxN7kmhNs9TfaUZQWOO64cd6bc&callback=myMap"></script>
                </div>
            </div>
                </div>
            </div>
